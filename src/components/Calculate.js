...
const Calculate = () => {
  return (
    <section className='calculate'>
      <div className='calculate-title flex flex-col justify-center items-center pt-5 lg:pt-10 pb-80 lg:pb-48 relative md:px-11 lg:px-32'>
        <h3 className='text-4xl font-bold py-4 text-center w-10/12 lg:w-6/12'>Check how much you can earn</h3>
        <p className='text-base text-center text-gray-400 lg:px-28 py-4 w-10/12  lg:w-6/12'>Let's check your hash rate to see how much you will earn today, Exercitation veniam consequat sunt nostrud amet.</p>
      ...
      <div className='trader flex flex flex-col justify-center items-center relative pb-10 pt-64 lg:pt-48 md:px-11 lg:px-32'>
        ...
        <div className='currencies flex flex-col lg:flex-row justify-center items-center'>
          ...
          <div className='flex flex-col ethereum mx-6 crypto-card justify-center items-center px-4 w-8/12 md:w-9/12 lg:w-3/12'>
          ...
          <div className='flex flex-col litecoin mx-6 crypto-card justify-center items-center px-4 w-8/12 md:w-9/12 lg:w-3/12'>
            ...
            <p className='text-center py-3'>Cryptocurrency that enables instant payments to anyone in the world.</p>
            <div className='btn w-fit p-3 my-5 rounded-3xl text-white mb-16 start-mining'>Start Mining <span className='mx-3'><MdKeyboardArrowRight className='inline'/></span></div>
