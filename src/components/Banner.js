  ...
  return (
    <section className='banner flex md:px-11 lg:px-32 relative'>
      <div className='flex flex-col lg:flex-row py-5 pl-3'>
        <div className='banner-details flex flex-col justify-center lg:w-1/2 animate__animated animate__backInLeft animate__slow'>
        ...
        <div className='banner-illustration px-3 lg:w-1/2 animate__animated animate__backInRight animate__slow'><img src={illustration} alt='bitcoin illustration' className='illustration'/></div>
